<div
	class="relative left-0 z-50 w-full overflow-hidden bg-gradient-to-br from-slate-800 to-slate-800/95 py-24 mix-blend-multiply backdrop-blur"
>
	<div class="relative mx-auto max-w-7xl px-4 md:px-6">
		<a id="about"
			><h2
				class="relative z-10 mx-auto font-['Roboto_Mono'] text-xl leading-none tracking-tight text-[#fce4b8]"
			>
				<span class="text-white/50">~/</span>ABOUT ME
			</h2></a
		>
		<p class="cursor -ml-2 mb-20 block font-['Roboto_Mono'] text-lg text-white/50" id="cursor-2">
			&#x2590;
		</p>
		<p
		...
		<div class="gap-24 text-pretty md:columns-2">
			...
			<p class="mt-8 text-sm leading-normal text-slate-400 sm:text-base">
				...
				to be a fanatic of Uncle Bob's Clean Coding, Clean Architecture and SOLID. Although I still
				value some of these ideas, I have more appreciation for simplicity and am averse to
				unjustified complexity, premature optimization and over-engineering in general.
			</p>
			<p class="mt-8 text-sm leading-normal text-slate-400 sm:text-base">
